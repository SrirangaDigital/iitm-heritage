            ...
            <form action="<?=BASE_URL?>data/sign_out/<?=$data[0]['id']?>/4" method="POST">
                <div class="firsthalf">
                    ...
                    <div class="form-group d-flex justify-content-center align-items-center mb-4">
                        ...
                        <input type="text" class="form-control text-center textbox-bg w-50 mx-3" id="sign_out_date" name="sign_out_date" placeholder="22 October 2024">
                    ...
                    <div class="form-group d-flex justify-content-center align-items-center mb-5">
                        ...
                        <input type="text" class="form-control text-center textbox-bg w-50 mx-3" id="sign_out_time" name="sign_out_time" placeholder="18:23">
                        <img src="<?=PUBLIC_URL?>images/vector-7.svg" class="ms-1" alt="icon" width="40" height="40" />
                    </div>
