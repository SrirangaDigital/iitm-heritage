...
<div class="exhibits-list">              
  ...
  <div class="input-group d-flex justify-content-center align-items-center mb-5">
    <div class="d-flex align-items-center bg-label px-3 py-1 me-1 rounded" style="width: 96%;">
      <label for="otherexhibit" class="me-2 mb-0">Other</label>
      <input type="text" id="otherexhibit" name="otherexhibit" value="<?= (isset($_SESSION["formdata"]["otherexhibit"]))? $_SESSION["formdata"]["otherexhibit"] : "";  ?>" class="form-control border-0 textbox-bg me-2" placeholder="Specify...">
    </div>
