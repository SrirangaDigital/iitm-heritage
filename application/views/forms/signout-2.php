...
<div class="checkbox-wrapper">
  ...
  <div class="d-flex align-items-center bg-light p-2 rounded w-100">
    ...
    <input type="text" id="otherexhibit" name="otherexhibit" value="<?= (isset($_SESSION["formdata"]["otherexhibit"]))? $_SESSION["formdata"]["otherexhibit"] : "";  ?>" class="form-control border-0 bg-light me-2" placeholder="Specify...">
