                ...
                <div class="firsthalf">
                    ...
                    <div class="form-group d-flex justify-content-center align-items-center mb-5 custom-select">
                        <div class="custom-select-wrapper dropdown" data-target-select-id="department">
                            <select class="d-none" id="department" name="department" aria-label="Select Department">
                              <option value="" class="emptyselect fst-italic" selected disabled>Select Department</option>
