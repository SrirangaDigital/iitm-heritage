...
<div class="container h-100">
    <div class="row  h-100 justify-content-center align-items-center">
        <div class="col-md-1 text-center">
            ...
            <span><a href="<?=BASE_URL?>data/test/<?=$viewHelper->getHrefNumber($_SESSION['formdata']['visitor_type'])?>"><i class="bi bi-arrow-left-circle h3"></i></span></a>
        </div>    
        <div class="col-md-6 text-center">
            <p class="text-end my-5"><a href="<?=BASE_URL?>data/test/99"><i class="bi bi-x h2"></i></a></p>
            <form action="<?=BASE_URL?>data/test/7" method="POST">                    
