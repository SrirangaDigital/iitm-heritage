    ...
    <div class="row justify-content-center align-items-center">
        <div class="col-md-7 text-center">
            <form action="<?=BASE_URL?>data/sign_in/6" method="POST">
                <div class="firsthalf">
                    <label for="designation" class="form-label label-text-info mb-4 mt-5">Enter your <span class="coloured">Designation</span></label>
                    <div class="form-group d-flex justify-content-center align-items-center mb-5">
                        <input type="text" class="form-control textbox-bg w-75 mx-2" id="designation" name="designation" value="<?= (isset($_SESSION["formdata"]["designation"]))? $_SESSION["formdata"]["designation"] : '';  ?>" placeholder="Type your Designation">
