...
<head>
    ...
    –––––––––––––––––––––––––––––––––––––––––––––––––– -->
    <meta charset="utf-8">
    <title><?php if($pageTitle) echo $pageTitle . ' | '; ?>Heritage Center &mdash IIT Madras</title>
...
<!-- 
 ...
 -->
    ...
    <!-- Favicon
    –––––––––––––––––––––––––––––––––––––––––––––––––– -->
    <link rel="icon" type="image/png" href="<?=PUBLIC_URL?>images/favicon.png?v=1.1">
</head>
<body class="vh-100">
    <!-- Navigation
    –––––––––––––––––––––––––––––––––––––––––––––––––– -->
        ...
        <nav class="navbar navbar-expand-md fixed-top">
            <div class="container-fluid">  
                <a class="navbar-brand p-0" href="">
                    <img src="<?=PUBLIC_URL?>/images/iitm-heritage.png" alt="Logo" class="logo d-inline-block  align-middle">
                    <span class="navbar-text align-middle d-inline-block navbar-app-title text-white p-0" id="navbarText">
                        <i class="fs-6">IIT MADRAS</i> <br>Heritage Center
                    </span>
                </a>
                ...
                <div class="collapse navbar-collapse navbar-center" id="navbarCollapse">
                    <ul class="navbar-nav ml-auto d-flex flex-row gap-5">
                        <li class="nav-item active">
                            <a class="nav-link" href="<?=BASE_URL?>">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?=BASE_URL?>History">Profiles</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?=BASE_URL?>Book">Sign In</a>
                        </li>                        
                        <li class="nav-item">
                            <a class="nav-link" href="<?=BASE_URL?>Life_X-verse">Sign Out</a>
                        </li>                        
                    </ul>
                </div>
            </div>
